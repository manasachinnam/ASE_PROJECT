...
class Ui_Register(object):
    ...
    def registering(self):
        ...
        try:
            ...
            if name == "" or name == "null" or unm == "" or unm == "null" or pwd == "" or pwd == "null" or email == "" or email == "null" or mno == "" or mno == "null":
                ...
                sql = "select count(*) from employee where emp_Id='" + unm + "'"
                cursor.execute(sql)
                res = cursor.fetchone()[0]
                if res > 0:
                    self.showMessageBox("Information", "Employee Id already exists..!")
                else:
    ...
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(180, 30, 281, 51))
...
"")
        ...
        self.label_3.setGeometry(QtCore.QRect(100, 190, 141, 51))
        self.label_3.setStyleSheet("color: rgb(0, 0, 0);\n"
"font: 16pt \"Gabriola\";")
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(Dialog)
        self.label_4.setGeometry(QtCore.QRect(100, 300, 101, 16))
...
"font: 16pt \"Gabriola\";")
        ...
        self.label_6.setGeometry(QtCore.QRect(100, 460, 101, 20))
...
"font: 75 14pt \"Times New Roman\";")
        ...
        self.label_7.setStyleSheet("image: url(../EmotionsDetection/images/registration.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Employee ID"))
