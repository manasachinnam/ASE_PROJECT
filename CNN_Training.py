...
def build_cnnmodel():
        ...
        train_dir = '..\EmotionsDetection\dataset\\train'
        val_dir = '..\EmotionsDetection\dataset\\test'
        ...
        # save model
        if os.path.exists("..\EmotionsDetection\cnn_model.hdf5"):
                pass

        else:
                emotion_model.save("..\EmotionsDetection\cnn_model.hdf5")

        print("[INFO] CNN model Trained Successfully..!")
